...
// Svertka.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSvertkaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSvertkaApp

CSvertkaApp::CSvertkaApp()
{
...
// Единственный объект CSvertkaApp

CSvertkaApp theApp;


// Инициализация CSvertkaApp

BOOL CSvertkaApp::InitInstance()
{
